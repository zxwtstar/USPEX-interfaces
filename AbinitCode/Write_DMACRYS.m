...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
 unixCmd(['cat /dev/null > mol.res.punch']);
 unixCmd(['cat /dev/null > mol.res']);
    ...
    if ~(length(POP_STRUC.POPULATION(Ind_No).LATTICE)==6)
     ...
     fprintf(fid,'CELL 1.0000 %8.3f %8.3f %8.3f %8.3f %8.3f %8.3f\n', lat);
     fprintf(fid,'LATT -1\n');  
     fprintf(fid,'SFAC  '); 
